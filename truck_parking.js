document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById('check-form').addEventListener('submit', (e) => {
        ...
        fetch('check_location of truck.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
        ...
        .then(data => {
            const locationText = data.success
                ...
                : "truck not found or not parked yet.";
            document.getElementById('truck-location').textContent = locationText;
        });
    });
